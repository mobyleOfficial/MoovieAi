...
| [AI_AGNOSTIC_SUBMODULES](rules/common/AI_AGNOSTIC_SUBMODULES.md) | Child repos (`muuvie`, `backend`) must remain AI-agnostic. No `CLAUDE.md`, `.claude/`, `.cursorrules`, `copilot-instructions.md`, `AGENTS.md` inside submodules. |
