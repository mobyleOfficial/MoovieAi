...
Flutter scaffolding (new datasource, repository, usecase, UI module) lives under [`commands/`](../../commands/) at the repo root and is invoked via slash commands (`/new-datasource`, `/new-repository`, `/new-usecase`, `/new-ui-module`) — not as skills. See [`agents/flutter-implementer-tester.md`](../../agents/flutter-implementer-tester.md) for pipeline usage.
